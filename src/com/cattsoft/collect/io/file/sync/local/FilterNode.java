...
class FilterNode {
	 ...
	 * @param inverted
	 *            true if the match result for this leaf node is inverted; false
	 *            otherwise
	 * @param expression
	 *            Regex/glob expression to be compiled to an equivalent Java
	 *            regex pattern
	 */
	FilterNode(final FilterType type, final boolean inverted,
			final String expression) throws PatternSyntaxException {
		this.logic = null;
		this.children = null;
	 ...
	 */
	public void addFilter(final FilterNode child) {
		...
		if (this.children == null) {
			...
			if (this.children.isEmpty())
				throw new RuntimeException(
						"FilterNode object is a non-leaf node without any children");
	 ...
	 */
	private static Pattern globToRegexPattern(final String glob)
