...
class TerminatingException extends RuntimeException {
	 ...
	 * 
	 * @param message
	 *            Exception message; saved for later retrieval by the
	 *            Throwable.getMessage() method
	 * @param exitCode
	 *            Exit status code; saved for later retrieval by the
	 *            TerminatingException.getExitCode() method
	 */
	public TerminatingException(final String message, final int exitCode) {
		super(message);
	 ...
	 *            Throwable.getMessage() method
	 */
	public TerminatingException(final String message) {
		super(message);
		this.exitCode = 1;
	}
